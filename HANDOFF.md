...
1. 원본 stage_map frame 67 엔딩 화면 이식
2. 박스 Sprite 356의 2~13프레임 그래픽 복원 및 애니메이션 적용
3. 플레이어 Sprite 370의 71~76프레임 성공 반응 애니메이션 적용
4. 박스 목표 진입 시 두 애니메이션 원본 타이밍 동기화
5. Galaxy S8 / S10에서 게임 영역과 D-pad 크기 실기기 미세 조정
