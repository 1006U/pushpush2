...
게임 화면은 원본 SWF의 **240×250 논리 해상도**를 기준으로 레터박스 방식으로 표시합니다.
스테이지마다 타일 크기가 달라지지 않고, 원본의 14×14 픽셀 격자 크기를 같은 비율로 유지합니다.
